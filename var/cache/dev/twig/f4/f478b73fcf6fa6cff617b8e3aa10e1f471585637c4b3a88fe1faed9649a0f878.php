...
<h1> connexion de l'utilisateur</h1>
    ";
            ...
            if ((isset($context["error"]) || array_key_exists("error", $context) ? $context["error"] : (function () { throw new RuntimeError('Variable "error" does not exist.', 9, $this->source); })())) {
                // line 10
                echo "        ";
                echo $this->extensions['Symfony\Bridge\Twig\Extension\DumpExtension']->dump($this->env, $context, (isset($context["error"]) || array_key_exists("error", $context) ? $context["error"] : (function () { throw new RuntimeError('Variable "error" does not exist.', 10, $this->source); })()));
                echo "
        <div>";
                // line 11
    ...
    <form action=\"";
          ...
          <div class =\"form-group\">
               <input placeholder=\"idUtilisateur\" required name = \"_username\"
...
";
    ...
    {
        return array (  127 => 40,  119 => 35,  116 => 34,  95 => 16,  90 => 13,  85 => 11,  80 => 10,  78 => 9,  73 => 6,  71 => 5,  68 => 4,  58 => 3,  35 => 1,);
    }
...
<h1> connexion de l'utilisateur</h1>
    ...
    {% else %}
        ...
        <a href=\"{{ path('security_deconnexion') }}\" >Deconnexion</a>
...
{% endblock %}", "security/login.html.twig", "/var/www/html/monprojet/templates/security/login.html.twig");
    }
}
