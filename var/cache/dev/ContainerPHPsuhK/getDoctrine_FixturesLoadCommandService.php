...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/FichePedagoFixture.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/ParcoursFixture.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/SemestreFixture.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/UeFixture.php';
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\EtudiantFixture(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\FichePedagoFixture(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\ParcoursFixture(), 'groups' => []], 3 => ['fixture' => new \App\DataFixtures\SemestreFixture(), 'groups' => []], 4 => ['fixture' => new \App\DataFixtures\UeFixture(), 'groups' => []], 5 => ['fixture' => new \App\DataFixtures\UserFixture(($container->services['security.password_encoder'] ?? $container->load('getSecurity_PasswordEncoderService'))), 'groups' => []]]);
